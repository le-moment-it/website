...
:::warning Why it is not recommended 👆
...
As soon as a new machine is instantiated with this golden image, it will automatically download the website from S3 and will be ready to serve traffic 🚀
