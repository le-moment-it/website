...
<Tabs>
  <TabItem value="atmos" label="Atmos" default>
...
**More details about stacks in the next sections of this documentation 🧑‍💻**
  ...
  <TabItem value="terraspace" label="Terraspace" default>
...
<Tabs>
  <TabItem value="agnostic" label="Environment-Agnostic" default>
...
```
  ...
  <TabItem value="none-agnostic" label="None-Environment-Agnostic" default>
...
<Tabs>
  <TabItem value="terraspace-cac" label="Terraspace" default>
...
```
  ...
  <TabItem value="atmos-cac" label="Atmos" default>
...
```
  ...
  <TabItem value="php" label="Php-Composer" default>
...
```
  ...
  <TabItem value="yaml" label="Atmos-YAML" default>
```yaml
    vpc:
      metadata:
        component: vpc
...
<Tabs>
  <TabItem value="network" label="Component: network" default>
```hcl
...
```
  ...
  <TabItem value="instance" label="Component: instance" default>
```hcl
...
```
  ...
  <TabItem value="infrastructure" label="Layer: infrastructure" default>
```yaml
components:
  terraform:
    network:
...
<Tabs>
  <TabItem value="component" label="Only One Component" default>
    <Terminal  prompt="bash:"
    title="Deploy Only one component"
    lines={[
        "export HCLOUD_TOKEN=....",
...
```
  ...
  <TabItem value="stack" label="Full Dev Environment" default>
    <Terminal  prompt="bash:"
    title="Deploy Only one component"
    lines={[
        "export HCLOUD_TOKEN=....",
