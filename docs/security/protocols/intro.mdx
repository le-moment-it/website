...
`.trim();
const srl = `
7A3C8F1B5EXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
          ...
          children: [
            {
              ...
              children: [
                ...
                { name: 'client_c_root_ca.crt', type: 'file', content: certificate },
                { name: 'client_c_root_ca.srl', type: 'file', content: srl },
              ]
            },
            {
              name: 'csr',
          ...
          children: [
            {
              ...
              children: [
                ...
                { name: 'client_b_root_ca.crt', type: 'file', content: certificate },
                { name: 'client_b_root_ca.srl', type: 'file', content: srl },
              ]
            },
            {
              name: 'csr',
...
return [
    {
      ...
      children: [
        ...
        },
        {
          ...
          type: 'directory',
          children: [
            { name: 'client_b_to_client_c.csr', type: 'file', content: csr },
            { name: 'client_b.key', type: 'file', content: key },
          ],
        },
        {
          name: 'client_c_ca',
...
return [
    {
      ...
      children: [
        ...
        },
        {
          ...
          type: 'directory',
          children: [
            { name: 'client_b_signed_by_client_c.crt', type: 'file', content: certificate },
            { name: 'client_b_to_client_c.csr', type: 'file', content: csr },
            { name: 'client_b.key', type: 'file', content: key },
            { name: 'client_c_ca_chain.crt', type: 'file', content: chain },
          ],
        },
        {
          name: 'client_c_ca',
          ...
          children: [
            {
              ...
              children: [
                ...
                { name: 'client_c_ca_chain.crt', type: 'file', content: chain },
                { name: 'client_c_intermediate_ca.crt', type: 'file', content: certificate },
                { name: 'client_c_intermediate_ca.srl', type: 'file', content: srl },
                { name: 'client_c_root_ca.srl', type: 'file', content: srl },
                { name: 'client_c_root_ca.crt', type: 'file', content: certificate },
              ]
            },
          ...
          children: [
            {
              ...
              children: [
                ...
                { name: 'client_c_root_ca.crt', type: 'file', content: certificate },
                { name: 'client_c_root_ca.srl', type: 'file', content: srl },
                { name: 'client_c_server.crt', type: 'file', content: certificate },
              ]
            },
            {
              name: 'csr',
              ...
              children: [
                { name: 'client_b_to_client_c.csr', type: 'file', content: csr },
                { name: 'client_c_intermediate_ca.csr', type: 'file', content: csr },
                { name: 'client_c_server.csr', type: 'file', content: csr },
              ]
            },
            {
              name: 'private',
              ...
              children: [
                { name: 'client_c_intermediate_ca.key', type: 'file', content: key },
                { name: 'client_c_root_ca.key', type: 'file', content: key },
                { name: 'client_c_server.key', type: 'file', content: key },
              ]
            },
          ]
        },
